				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" id="<?php if(isset($driver)): echo "driver_update"; else: echo "drivermaster"; endif; ?>">						
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="driver_pan" name="driver_pan" value="<?php if(isset($driver)): echo $driver[0]->driver_panno; endif; ?>" placeholder="Enter Driver Pan No" class="col-xs-10 col-sm-5 "  onKeyUp="javascript:return check_isalphanumeric(event,this);"/>
								<span class="help-inline col-xs-12 col-sm-7">
									<span class="middle input-text-error" id="driver_licence_errorlabel"></span>
								</span>
							</div>
