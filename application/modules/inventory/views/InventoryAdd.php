					...
					<form class="form-horizontal" role="form">						
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<span class="help-inline col-xs-12 col-sm-7">
									<span class="middle input-text-error hidden" id="name-error">Enter Name</span>
								</span>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Enter Item Unit</label>

							<div class="col-sm-9">
								<input type="text" id="unit" placeholder="" class="col-xs-10 col-sm-5" />
								<span class="help-inline col-xs-12 col-sm-7">
									<span class="middle input-text-error hidden" id="unit-error">Enter Unit</span>
								</span>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Enter Item Qty</label>

							<div class="col-sm-9">
								<input type="text" id="qty" placeholder="" class="col-xs-10 col-sm-5" />
								<span class="help-inline col-xs-12 col-sm-7">
									<span class="middle input-text-error hidden" id="qty-error">Enter Quantity</span>
								</span>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Enter Item Cost</label>

							<div class="col-sm-9">
								<input type="text" id="cost" placeholder="" class="col-xs-10 col-sm-5" />
								<span class="help-inline col-xs-12 col-sm-7">
									<span class="middle input-text-error hidden" id="cost-error">Enter Cost</span>
								</span>
							</div>
						</div>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<button class="btn btn-info" type="button" id="addInventoryItem">
