				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" id="<?php if(isset($staff)): echo "staff_update"; else: echo "staffmaster"; endif; ?>">						
						<div class="form-group">
							<label class="col-sm-2 no-padding-right" for="form-field-2"> Staff Name*</label>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="vendor_gst" name="vendor_gst"  value="<?php if(isset($vendor)): echo $vendor[0]->vendor_gst; endif; ?>" placeholder="Enter  GST " class="col-xs-10 col-sm-5 mandatory-field" />
								<span class="help-inline col-xs-12 col-sm-7">
